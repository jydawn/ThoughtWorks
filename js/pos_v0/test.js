...
let allCodes = ['||:::', ':::||', '::|:|', '::||:', ':|::|', ':|:|:', ':||::', '|:::|', '|::|:', '|:|::'];
function totalChangTocodes(inputs){
    let checkResult = checkNumber(inputs);
    console.log(checkResult);
    changeToCodes(inputs,checkResult);
    console.log(changToCodes());
}
...
function changeToNumber(temp,checkNode) {
